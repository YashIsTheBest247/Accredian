      ...
      <div className="container-page">
        ...
        <div className="relative mt-14">
          ...
          <button
            ...
            className="absolute -left-3 top-1/2 hidden h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-slate-200 bg-white text-ink shadow-md transition-colors hover:bg-brand-50 hover:text-brand-600 lg:grid"
          >
          ...
          <button
            ...
            className="absolute -right-3 top-1/2 hidden h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-slate-200 bg-white text-ink shadow-md transition-colors hover:bg-brand-50 hover:text-brand-600 lg:grid"
          >
