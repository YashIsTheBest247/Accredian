        ...
        <div className="mx-auto mt-14 grid max-w-5xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {domains.map((d, i) => (
            <Reveal key={d.title} delay={i * 60}>
              <div className="group flex flex-col items-center gap-4 rounded-2xl border border-slate-100 bg-white p-8 text-center shadow-[0_8px_30px_-16px_rgba(16,24,40,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_40px_-16px_rgba(26,115,232,0.35)]">
